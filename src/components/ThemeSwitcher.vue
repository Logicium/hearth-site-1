...
// hearth = lodging: Amenities layout
const SITE_STYLE_LABEL = 'Amenities layout'
const SITE_STYLE_LABELS: Record<string, string> = { '1': 'Ledger', '2': 'Mosaic', '3': 'Index', '4': 'Marquee', '5': 'Medallion' }
...
const sectionTargets = {
  ...
  subhero:   { selectors: ['.ap-subhero'],                               route: '/rooms' },
  footer:    { selectors: ['.ap-footer'],                                route: '/' },
  site:      { selectors: ['.ap-menu', '.ap-amenities', '.ap-products', '.ap-categories'], route: '/rooms' },
  contact:   { selectors: ['.ap-contact'],                               route: '/book' },
  hours:     { selectors: ['.ap-hours'],                                 route: '/book' },
